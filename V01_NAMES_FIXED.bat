@echo off
echo ========================================
echo INSTALANDO EFFECT SCANNER V01 NAMES FIXED
echo ========================================
echo.
...
echo.
echo ========================================
echo INSTALACION V01 NAMES FIXED COMPLETA
echo ========================================
echo.
echo CORRECCIONES EN V01 NAMES FIXED:
echo - Mejor limpieza de nombres de efectos
echo - Preserva guiones en nombres (ej: Deep Glow 2)
echo - Solo reemplaza guiones bajos con espacios
echo - Intenta variaciones automaticas si falla
...
echo 4. Prueba aplicar "Deep Glow 2" - deberia funcionar
echo.
pause
