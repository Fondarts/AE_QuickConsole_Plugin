// Auto-scan version using the working debug logic
var allEffects = null;
...
function initializeEffects() {
    ...
    try {
        ...
        try {
            var debugFileName = "AE_Plugin_Scan_Debug_" + new Date().getFullYear() + "_" + (new Date().getMonth() + 1) + "_" + new Date().getDate() + ".txt";
            var desktopPath = Folder.desktop.fsName;
            var debugFilePath = desktopPath + "/" + debugFileName;
            var debugFile = new File(debugFilePath);
            
            if (debugFile.open("w")) {
                debugFile.write("After Effects Plugin Scan Debug\n");
                debugFile.write("==============================\n");
...
// Test function
function testJSX() {
    return "JSX is working! Found " + (allEffects ? allEffects.length : 0) + " effects";
}
