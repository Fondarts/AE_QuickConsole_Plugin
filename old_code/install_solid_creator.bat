@echo off
echo ========================================
echo Solid Creator Plugin - Simple Version
echo ========================================
echo.
...
echo Installing Solid Creator (simple version)...
echo.
...
echo Creating simple manifest for Solid Creator...
echo.

REM Create a simple manifest for Solid Creator
...
if %errorLevel% == 0 (
    echo.
    echo ========================================
    echo Solid Creator Installed Successfully!
    echo ========================================
    echo.
    echo The Solid Creator plugin has been installed.
    echo.
    echo Next steps:
    echo 1. Restart After Effects completely
    echo 2. Go to Window ^> Extensions ^> Solid Creator
    echo 3. Click any color button to create a solid layer
    echo.
    echo This simple version only creates colored solids.
    echo If it works, we can add more features.
    echo.
) else (
    echo.
    echo ========================================
